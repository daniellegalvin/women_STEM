...
#7.8 % probability that the selected schools in the Midwest have more women employed in tt positions compared to selected schools in the South.
...
# 2.15 % probability that the selected schools in the Midwest have more women employed in tt positions compared to selected schools in the Southwest region.

tt_diff %>% 
  summarize(higher=sum(MW_NW_f_tt>0)/nrow(.))
# 0.03% probability that the selected schools in the Midwest have more women employed in tt positions compared to selected schools in the Northwest region.
```
